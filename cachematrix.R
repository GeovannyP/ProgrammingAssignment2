# Matriz inversa
# There are some aplications for Matrix inversion, but it is usually a costly computation of it.
# some programs let do it easily with functions. Below functions are used to create a special object 
